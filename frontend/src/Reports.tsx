...
type Sale = { id:number;date:string;grade?:'M500'|'M600';client?:string;bags?:number;material?:'SAND'|'GRAVEL';tons?:number;concreteGrade?:string;address?:string;volume?:number;paid?:boolean;amount:number;kind?:'cement'|'concrete' };
